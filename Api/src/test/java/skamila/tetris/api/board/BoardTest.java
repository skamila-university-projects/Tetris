...
class BoardTest {
	...
	public void boardWithOneRow() {
		...
		BoardField[][] fields = {{new BoardField(), new BoardField(), new BoardField()}};
	...
	public void outOfBoardException() {
		...
		assertThrows(OutOfBoardException.class, () -> board.setField(new BoardField(), 3, 2));
		assertThrows(OutOfBoardException.class, () -> board.setField(new BoardField(), 2, 3));
		assertThrows(OutOfBoardException.class, () -> board.setField(new BoardField(), -1, 2));
		assertThrows(OutOfBoardException.class, () -> board.setField(new BoardField(), 2, -1));
	}
